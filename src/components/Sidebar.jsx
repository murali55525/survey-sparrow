  ...
  return (
    <div 
      className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} 
                 ...
                 w-64 md:w-64 lg:w-72 p-6 flex flex-col border-r border-gray-200/50 shrink-0 overflow-y-auto
                 bg-white/95 md:bg-white/90 backdrop-blur-2xl transition-all duration-500 md:translate-x-0
                 shadow-2xl md:shadow-xl rounded-r-3xl border border-white/50`}
    >
      ...
      <button 
        className="group mb-8 flex items-center justify-center px-6 py-4 rounded-2xl shadow-lg border border-white/50 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold text-sm transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:from-blue-600 hover:to-purple-700 relative overflow-hidden"
        onClick={() => {
